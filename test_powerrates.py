...
class TestPowerwallConnectivity(unittest.TestCase):
    ...
    def test_powerwall_api_connectivity(self):
        ...
        update_actual_powerwall = False
        # Step 4: Set complete Time of Use and Tariff configuration
        if not update_actual_powerwall:
            print("Skipping actual Powerwall configuration")
        else:
            print(
            ...
            try:
                    ...
                    "tou_settings": {
                        ...
                        "tariff_content_v2": {
                            ...
                            "energy_charges": {
                                "ALL": {"rates": {"ALL": 0}},
                                "Summer": {
                                    "rates": {"OFF_PEAK": 0.15, "ON_PEAK": 0.35}
                                },
                                "Winter": {
                                    "rates": {"OFF_PEAK": 0.12, "ON_PEAK": 0.30}
                                },
                            },
                            "sell_tariff": {
                                "energy_charges": {
                ...
                settings_url = f"{base_url}/api/1/energy_sites/{energy_site_id}/time_of_use_settings"
                ...
                self.fail(
                    f"❌ Failed to set complete TOU and tariff configuration: {e}"
                )
